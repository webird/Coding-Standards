...
* 使用符合语义的标签书写HTML文档，使用恰当的元素表达所需的含义，保证去掉样式后仍然有很强的可读性，查阅[w3cschools](http://www.w3schools.com/)和[http://html5doctor.com/](http://html5doctor.com/)，尽量使用标准的语义化标签，而不是使用大量的div代替。
