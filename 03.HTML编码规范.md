...
* 选择图片的规定：
** png是最好的选择，一般情况下使用png格式的图片；**
** gif是需要很小的图片的时候使用，小于10*10的时候或者当调色板不到3的颜色；**
** jpg是当需要摄影风格的图片或者高清质量的时候使用；**
** 不要使用bmp或者tiff格式的图片。**
...
```html
<!-- 不推荐 -->
<script src="http://s14.cnzz.com/stat.php?id=3384629&web_id=3384629&show=pic"></script>
<!-- 推荐 -->
